					...
					<div class="widgetbox box-inverse">
						...
						<div class="widgetcontent wc1">
							<form:form id="form1" cssClass="stdform" method="post"
								action="${pageContext.request.contextPath}/tintuc/modify"
								modelAttribute="tintucForm">
								<form:hidden path="maTin" />
								<div class="par control-group">
									<label class="control-label" for="name">nguoi dang</label>
									<div class="controls">
										<form:input type="text" path="maNv.ten" id="name"
											cssClass="input-large" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="ngayDang">ngày đăng</label>
									<div class="controls">
										<form:input type="text" path="ngayDang" id="ngayDang"
											cssClass="input-large" />
									</div>
								</div>
								<div class="par control-group">
									<label class="control-label" for="tieuDe">Tiêu đề</label>
									<div class="controls">
										<form:input type="text" path="tieuDe" id="tieuDe"
								...
								<div class="par control-group">
									...
									<div class="controls">
										<form:input type="text" path="noiDung" id="noiDung"
											cssClass="input-xlarge" />
									</div>
								</div>
