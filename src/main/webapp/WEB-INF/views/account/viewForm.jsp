	...
	<div class="mainwrapper">
		...
		<div class="rightpanel">
			<ul class="breadcrumbs">
				...
				<li><a href="${pageContext.request.contextPath}/account/view">Account</a>
				...
				<div class="panel panel-default qp-div-information">
					...
					<div class="panel-body">
						<table class="table table-bordered qp-table-form">
							...
							<c:forEach items="${accountList}" var="account" varStatus="sts">
								<tr>
									<td class="com-output-integer">${sts.index + 1}</td>
									<td class="com-output-text"><span class="strike">${account.accountId }</span>
									</td>
									<td class="com-output-text"><span class="strike">${account.username }</span>
									</td>
									<td class="com-output-text"><span class="strike">${account.password }</span>
									</td>
									<td class="com-output-text"><span class="strike">${account.permission }</span>
									</td>
									<td class="com-output-text"><a
										href="${pageContext.request.contextPath}/account/modify?id=${account.accountId}"><span
											class="glyphicon glyphicon-pencil" aria-hidden="true">edit</span></a>
									</td>
									<td class="com-output-text"><a
										href="${pageContext.request.contextPath}/account/delete?id=${account.accountId}"><span
