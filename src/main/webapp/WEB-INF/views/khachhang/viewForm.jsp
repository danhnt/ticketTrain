...
<body>
	...
	<div class="rightpanel">
		...
		<form:form method="post" modelAttribute="khachHangForm">
				...
				<div class="panel-body">
					<table class="table table-bordered qp-table-form">
						...
						<tr>
							...
							<td><label>cmt</label></td>
							<td><label>Edit</label></td>
							<td><label>Delete</label></td>

						</tr>
						<c:forEach items="${khachhangList}" var="khachhang" varStatus="sts">
							<tr>
								<td class="com-output-integer">${sts.index + 1}</td>
								<td class="com-output-text"><span class="strike">${khachhang.khachHangId}</span>
								</td>
								<td class="com-output-text"><span class="strike">${khachhang.ten }</span>
								</td>
								<td class="com-output-text"><span class="strike">${khachhang.email }</span>
								</td>
								<td class="com-output-text"><span class="strike">${khachhang.phone }</span>
								</td>
								<td class="com-output-text"><span class="strike">${khachhang.cmt }</span>
								</td>
								<td class="com-output-text"><a
									href="${pageContext.request.contextPath}/khachhang/modify?id=${khachhang.khachHangId}"><span
										class="glyphicon glyphicon-pencil" aria-hidden="true">edit</span></a>
								</td>
								<td class="com-output-text"><a
									href="${pageContext.request.contextPath}/khachhang/delete?id=${khachhang.khachHangId}"><span
