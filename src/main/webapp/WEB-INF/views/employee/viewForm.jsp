				...
				<div class="panel-body">
					<table class="table table-bordered qp-table-form">
						...
						<tr>
							...
							<td><label>diaChi</label></td>
							<td><label>phone</label></td>
							<td><label>Edit</label></td>
							<td><label>Delete</label></td>

						</tr>
						<c:forEach items="${employeelist}" var="employee" varStatus="sts">
							<tr>
								<td class="com-output-integer">${sts.index + 1}</td>
								<td class="com-output-text"><span class="strike">${employee.id }</span>
								</td>
								<td class="com-output-text"><span class="strike">${employee.ten }</span>
								</td>
								<td class="com-output-text"><span class="strike">${employee.gioiTinh }</span>
								</td>
								<td class="com-output-text"><span class="strike">${employee.diaChi }</span>
								</td>
								<td class="com-output-text"><span class="strike">${employee.phone }</span>
								</td>
								<td class="com-output-text"><a
									href="${pageContext.request.contextPath}/employee/modify?id=${employee.id}"><span
										class="glyphicon glyphicon-pencil" aria-hidden="true">edit</span></a>
								</td>
								<td class="com-output-text"><a
									href="${pageContext.request.contextPath}/employee/delete?id=${employee.id}"><span
